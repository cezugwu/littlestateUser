...
const HomeApartment = ({apartment}) => {
    const {title, imagea, state, city, property_type, slug, price} = apartment;
    ...
    return(
        ...
        hover:bg-gray-100 hover:shadow-2xl transition duration-300 hover:-translate-y-1 
        cursor-pointer'>
            ...
            onClick={() => {
                ...
                <div className='font-jost font-light text-sm'>{property_type}</div>
            </div>
        </div>
    );
}
